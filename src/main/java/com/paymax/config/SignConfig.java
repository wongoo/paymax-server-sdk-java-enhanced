...
public class SignConfig {
    ...
    private static ThreadLocal<String> appThreadLocal = new ThreadLocal<String>();
    ...
    //Paymax提供给商户的AppId，登录网站后查看
    private static String defaultApp = "app_7hqF2S6GYXET457i";
