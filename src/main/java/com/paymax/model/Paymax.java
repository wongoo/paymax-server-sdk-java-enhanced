...
public abstract class Paymax extends PaymaxBase {
     ...
     */
    public static <T> T request(String url, String jsonReqData, Class<T> clazz) throws AuthorizationException, IOException, InvalidRequestException, InvalidResponseException {
     ...
     */
    public static  Map<String, String> buildPostRequest(String url, String jsonReqData) throws IOException, InvalidResponseException {
        Map<String, String> result = null;
     ...
     * @throws InvalidResponseException
     */
    public static PayFile buildDownloadGetRequest(String url) throws IOException, InvalidResponseException {
        HttpGet httpGet = new HttpGet(url);
     ...
     * @throws InvalidResponseException
     */
    private static PayFile verifyDownloadData(CloseableHttpResponse response) throws IOException, InvalidResponseException {
        HttpEntity entity = response.getEntity();
        PayFile payFile = null;
        if (entity != null) {
            try {
                ...
                if (Integer.valueOf(responseCode) == 200) {
                    ...
                    payFile = JSON.parseObject(EntityUtils.toString(entity, Charset.forName(PaymaxConfig.CHARSET)),PayFile.class);
